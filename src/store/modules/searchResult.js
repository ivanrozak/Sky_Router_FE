...
export default {
  ...
  actions: {
    ...
    getScheduleById(context, payload) {
      return new Promise((resolve, reject) => {
        axios
          .get(`${process.env.VUE_APP_URL}/api1/schedule/${payload}`)
          .then(response => {
